...
<html>
    ...
    <body>
        ...
        <jsp:useBean id="Libro" scope="request" class="com.emergentes.modelo.Libros"/>
            <form action="Controller"  method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>AUTOR: </td>
                        <td><input type="text" name="autor" value="<jsp:getProperty name="Libro" property="autor"/>"></td>
                    </tr>
                    <tr>
                        <td>RESUMEN: </td>
                        <td><input type="textarea" name="resumen" value="<jsp:getProperty name="Libro" property="resumen"/>"></td>
                    </tr>
                    <tr>
                        <td>MEDIO:</td>
